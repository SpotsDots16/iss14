...
public abstract partial class SharedAgentIdCardSystem : EntitySystem
{
    ...
    // DeltaV - Add number change handler for NanoChat
    [SubscribeLocalEvent]
    private void OnNumberChanged(Entity<AgentIDCardComponent> ent, ref AgentIDCardNumberChangedMessage args)
    {
        ...
        _nanoChat.SetNumber((ent.Owner, comp), args.Number);
...
/// <summary>
/// DeltaV - Sent from the agent ID UI to change the NanoChat number.
/// </summary>
[Serializable, NetSerializable]
